    ...
    def print_verify(self,results_print,verify_results,print_ver,model_data):
        ...
        self.args.verify_audit = audit_event(
            ...
            payload={
                ...
                "threshold_direction": "higher" if verify_results['error_type'].lower() in ['mae', 'rmse'] else "lower",
                "unclear_threshold_percent": int(thres_test_unclear * 100),
                "pass_threshold_percent": int(thres_test_pass * 100),
                "unclear_threshold": verify_results.get('unclear_higher_thres', verify_results.get('unclear_lower_thres')),
                "pass_threshold": verify_results.get('higher_thres', verify_results.get('lower_thres')),
