...
"""
#####################################################.
#       This file stores the OUTLIERS class         #
...
# class analysis:
#     """
#     Class containing all the functions from the ANALYSIS module.

#     Parameters
#     ----------
#     kwargs : argument class
#         Specify any arguments from the OUTLIERS module (for a complete list of variables, visit the ROBERT documentation)
#     """
...
#         _ = self.sanity_checks('initial', None)

#         # load database and perform data checks
#         csv_df = self.load_database()
...
# mete outliers module (detect usando RF, NN y GB, o los modelos que le digas, y luego te da el analisis y la base de datos sin outliers a partir del threshold)
...
# primero los test estadisticos, luego los outliers